...
---
$(make_ssh_key_secret_from_files "${DEPLOY_DIR}/ssh_nadir_key" "jupyterhub-slurm-ssh-nadir-key-${ENV_NAME}")
---
$(make_secret_from_file "${DEPLOY_DIR}/nadir_config" "server_address" "jupyterhub-slurm-nadir-config-${ENV_NAME}")
---
